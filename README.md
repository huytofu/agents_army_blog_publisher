...
- `DEPLOYMENT.md`: Lambda container deployment with EventBridge Scheduler, IAM, environment variables, rollout, rollback, weekly digest and blog API Lambda handler overrides, and Fargate fallback.